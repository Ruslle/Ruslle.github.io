...
if(isset($_GET["sel"])){
	...
	switch($smenu){
		...
		case "index": include("pages/admin/_edit_index.php"); break; // Редактирование главной страницы
		case "story_donations": include("pages/admin/_story_donations.php"); break; // История пожертвований
