<div class="s-bk-lf">
	<div class="acc-title2">Обменник</div>
</div>
<?PHP
...
В обменном пункте Вы можете обменять рубли для вывода на рубли для покупок. 
При обмене рублей Вы получаете +<?=$sonfig_site["percent_swap"]; ?>% на счет для покупок.<br /><br />
</div>
...
<table width="400" border="0" align="center">
  ...
  <tr>
   <BR /><td colspan="2" align="center"><BR /><input type="submit" name="swap" value="Обменять" class="btn_pay"></td>
  </tr>
</table>
<BR />
</div>								
