<div class="s-bk-lf">
	<div class="acc-title2">Заказ выплаты</div>
</div>
<div class="silver-bk">
<BR />
<?PHP
...
<center>Укажите более подходящую для Вас платежную систему из списка имеющихся.</center>
</div>
	...
	<center> <BR />
		...
		<BR /><BR />
		<input type="submit" name="swap" value="Выбрать" class="btn_pay">
	</center>		
	</form>
	<div class="clr"></div>		
</div>	
...
<table width="99%" border="0" align="center">
  <tr>
    <td><font color="#000;">PerfectMoney кошелек</font> [Начинается с <?=$pdata["first_char"]; ?>]<font color="#000;">:</font> </td>
  ...
  <tr>
    <td colspan="2" align="center"><input type="submit" name="swap" value="Заказать выплату" class="btn_pay"></td>
  </tr>
</table>
</form>
