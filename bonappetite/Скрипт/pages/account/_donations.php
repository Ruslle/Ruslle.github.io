...
?>
<div class="s-bk-lf">
	<div class="acc-title">Содействие проекту</div>
</div>
<div class="silver-bk">Вы можете активно участвовать в жизни проекта, пожертвовав любое количество серебра для развития проекта.
<div class="clr"></div>	
<BR />
<?PHP
# Пожертвование
